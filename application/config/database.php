 ...
 * hosts is: import database/marvysocials.sql through phpMyAdmin, edit .env, done.
 */
require_once APPPATH.'core/Env.php';
Env::bootstrap(rtrim(realpath(APPPATH.'..'), DIRECTORY_SEPARATOR));

if (!function_exists('marvy_db_stricton')) {
    /**
...
$db['default'] = array(
    ...
    // debugging is re-enabled after a successful connect in marvy_load_database().
    'db_debug' => FALSE,
    'cache_on' => FALSE,
    'cachedir' => '',
