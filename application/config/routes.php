...
$route['admin/payments/methods'] = 'admin/payments/methods';
$route['admin/payments/methods/(:any)/save'] = 'admin/payments/save_method/$1';
...
$route['admin/mail-queue'] = 'admin/content/mail_queue';
...
// The standing bank-account endpoint must sit above the api/payments/(:any)
// catch-all below, or "fundsvera" would be read as a payment reference.
...
$route['admin/currencies/base-rate'] = 'admin/currencies/set_base_rate';
