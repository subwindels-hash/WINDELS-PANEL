...
<section class="ws-page-hero">
  <div class="container" style="max-width:760px">
    ...
    <h1>Refund Policy</h1>
    <p class="ws-lede">Refunds on Averion Commerce return value to the prepaid wallet. They are not bank payouts. This page follows what the order engines actually do.</p>
