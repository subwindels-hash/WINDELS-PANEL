...
<section class="ws-page-hero">
  <div class="container">
    ...
    <p class="ws-lede">This policy describes the data this Averion Commerce instance actually handles — accounts, sessions, orders, optional payment and fulfilment providers, and the on-site assistant. It is written from the codebase, not copied from a generic template.</p>
