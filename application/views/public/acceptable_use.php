...
<section class="ws-page-hero">
  <div class="container" style="max-width:760px">
    ...
    <p class="ws-lede">Rules for using this Averion Commerce instance. Breaking them can mean a refused order, a locked account, or a report to a provider or authority.</p>
