...
<table class="table"><thead><tr>
  <?php if ($can_manage): ?><th style="width:1.5rem"><input type="checkbox" data-check-all=".listing-check" aria-label="Select every listing"></th><?php endif; ?>
