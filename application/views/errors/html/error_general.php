...
// Branded general error page — renders for show_error(): 403 Forbidden, 500
// server error, 503, etc. No debug detail is ever echoed to the visitor.
$heading = isset($heading) ? $heading : 'Something went wrong';
$message = isset($message) ? $message : 'The request could not be completed.';
$code = isset($status_code) ? (int)$status_code : 500;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="wrap">
    ...
    <div><span class="code"><?php echo htmlspecialchars($code); ?></span></div>
    <h1><?php echo htmlspecialchars($heading); ?></h1>
    <p><?php echo htmlspecialchars($message); ?></p>
    <div class="actions">
      <a class="btn btn-primary" href="/">Go to homepage</a>
      <a class="btn btn-secondary" href="/services">Browse services</a>
