...
/**
 * Partial: inline SVG icon (Lucide-style, 24x24, stroke="currentColor").
 *
 * Usage:
 *   $this->load->view('partials/icon', array('name' => 'check', 'class' => 'w-4 h-4'));
 *
 * The set is intentionally small; add glyphs here rather than inlining SVGs
 * across views so the design system stays consistent.
 */
$name = $name ?? '';
$cls  = $class ?? 'w-5 h-5';
$icons = array(
    ...
    'gift-card'  => '<rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><line x1="12" y1="10" x2="12" y2="19"/><path d="M9 5a2 2 0 0 1 3-1.7A2 2 0 0 1 15 5"/>',
...
?><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
  ...
  class="<?=htmlspecialchars($cls)?>" aria-hidden="true"><?=$svg?></svg>
