...
<footer class="ws-footer">
  <div class="container">
    <div class="ws-footer-grid">
      <div>
        ...
        <p class="muted mt-2" style="max-width:22rem">
          A prepaid reseller panel for social-media services, Nigerian VTU, virtual numbers,
    ...
    <div class="ws-footer-meta">
      <div>© <?=date('Y')?> WINDELS PANEL. Wallet balances are for spending on this platform only.</div>
