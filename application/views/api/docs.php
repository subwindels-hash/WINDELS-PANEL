  ...
  <div class="card">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr><td><span class="ws-method ws-post">POST</span></td><td><code>/payments/fundsvera/virtual-account</code></td><td>Create (or fetch) your permanent bank-transfer account. No body. Payments into it credit your wallet automatically.</td></tr>
