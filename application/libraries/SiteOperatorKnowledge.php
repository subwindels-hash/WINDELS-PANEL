...
class SiteOperatorKnowledge {
    ...
    public static function faqs() {
        return array(
            ...
            array('category' => 'General', 'q' => 'Which currency is used?', 'a' => 'The base currency is the accounting currency for wallet settlement, orders and the ledger. The default display currency is what customers pay when adding funds through Manual / Bank Transfer or Fundsvera; the confirmed deposit is converted to its base-currency settlement amount at the rate locked when it was opened.'),
